...
public class Emlak {
	...
	public static void guncelle(tree agac)
	{
		...
		System.out.println("DeÄŸiÅŸtirmek istemediÄŸiniz degerler yerine q harfi giriniz.");
		System.out.println("Isim:");
		String ad=scan.nextLine();
		System.out.println("Adres:");
		String adres=scan.nextLine();
	...
	public static void aramenu1(tree agac,Heap heap, Hashtable<Float, yeniBilgi> hash)
	{
		...
		System.out.println("9.ogrenciye uygun konutlarin, ilÃ§e bazinda ortalama fiyatlarinin bulunmasi");
		Scanner scan = new Scanner(System.in);
		secim=scan.nextInt();
